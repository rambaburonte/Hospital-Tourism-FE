...
const SpaUploadForm = () => {
  ...
  // Debug rendering
  useEffect(() => {
    console.log('SpaUploadForm rendered');
  }, []);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validateForm()) {
      console.log('Spa Service Data Submitted:', formData);
      alert('Spa service details submitted successfully!');
      setFormData({
        serviceName: '',
        description: '',
        price: '',
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full bg-white shadow-lg rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Upload Spa Service Details</h2>
