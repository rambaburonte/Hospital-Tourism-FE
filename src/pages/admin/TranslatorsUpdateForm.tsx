...
const TranslatorsUpdateForm = () => {
  ...
  // Debug rendering
  useEffect(() => {
    console.log('TranslatorsUpdateForm rendered for ID:', id);
  }, [id]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      console.log('Updated Translator Data:', formData);
      alert('Translator details updated successfully!');
      navigate('/admin/translators/listing');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full bg-white shadow-lg rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Update Translator Details</h2>
...
export default TranslatorsUpdateForm;