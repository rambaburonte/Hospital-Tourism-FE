...
//             <Logo />
//             <span className="ml-2 text-xl font-bold text-gray-800">Zynlogic</span>
//           </Link>
...
//                     <div className="absolute top-full left-0 mt-1 w-56 bg-white shadow-lg rounded-lg py-2 z-10 animate-fade-in">
...
//               <Link
//                 to="/login"
//                 className="py-2 px-4 text-center text-gray-700 hover:text-primary"
//                 onClick={closeMenu}
//               >
//                 Login
//               </Link>
//               <Link
//                 to="/register"
//                 className="py-2 px-4 text-center bg-primary text-white rounded-lg hover:bg-primary-dark"
//                 onClick={closeMenu}
//               >
//                 Register
//               </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/login" className="text-gray-600 hover:text-primary" aria-label="User profile">
                <User className="w-5 h-5" />
              </Link>
