      ...
      <div className="absolute top-full left-0 mt-2 w-56 bg-white shadow-lg rounded-lg py-2 z-10">
        {link.items?.map((item, idx) => (
          <Link
            key={idx}
            to={item.path}
            className="block px-4 py-2 text-gray-600 hover:bg-primary/10 hover:text-primary"
            onClick={closeMenu}
          >
            {item.name}
          </Link>
  ...
  const navLinks: NavLink[] = [
    ...
    },
    {
      ...
      items: [
        { name: 'Flight Booking', path: '/flights' },
        { name: 'Hotel Booking', path: '/hotels' },
        { name: 'Translators', path: '/translators' },
      ],
    },
    { title: 'About', path: '/about' },
    { title: 'Contact', path: '/contact' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/dashboard" className="text-gray-600 hover:text-primary" aria-label="Dashboard">
                <User className="w-5 h-5" />
              </Link>
              <Link to="/cart" className="text-gray-600 hover:text-primary" aria-label="Cart">
                <ShoppingCart className="w-5 h-5" />
              </Link>
              ...
              {!user ? (
                <>
                  <SignInButton mode="modal">
                    <button className="px-4 py-2 text-sm font-medium text-primary border border-primary rounded-md hover:bg-primary hover:text-white">
                      Login
                    </button>
                  </SignInButton>
          ...
          <div className="md:hidden mt-4 py-4 animate-slide-down">
            ...
            <div className="flex flex-col space-y-2 mt-4 pt-4 border-t border-gray-200">
              {!user ? (
                <>
                  <SignInButton mode="modal">
                    <button className="py-2 px-4 text-center text-gray-600 hover:text-primary font-medium">
                      Login
                    </button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <button className="py-2 px-4 text-center bg-primary text-white rounded-md hover:bg-primary-dark">
                      Register
                    </button>
                  </SignUpButton>
                </>
                ...
                <SignOutButton>
                  <button className="py-2 px-4 text-center bg-red-500 text-white rounded-md hover:bg-red-600">
                    Sign Out
                  </button>
                </SignOutButton>
              )}
